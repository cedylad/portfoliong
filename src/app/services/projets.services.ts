    ...
    projets: Projet[] = [
        {
            ...
            descriptionProjet: "HubertEat est un site web construit en utilisant PHP selon le modèle MVC. Il s'agit d'une plateforme de commande de nourriture. Ce projet a été développé dans le cadre d'un examen.",
            stateProjet: 'Terminé',
            frameworkProjet: 'Boostrap',
            lanagageProjet: 'PHP',
